...
for (modelName in c("9random", "2d", 
                    "3d", "3cand", "8cand", "0picky", "01MOE")) {
  ...
  ggsave(paste0(modelName, " VSE.png"),
         plot=vseGraph,
         width = 6.4, height = 2.4, dpi=125, units = "in")
  ...
  ggsave(paste0(modelName, " ASR1.png"),
         plot=ASR1,
         width = 6.4, height = 2.2, dpi=125, units = "in")
  ...
  ggsave(paste0(modelName, " ASR2.png"),
         plot=ASR2,
         width = 6.4, height = 2.4, dpi=125, units = "in")
}
